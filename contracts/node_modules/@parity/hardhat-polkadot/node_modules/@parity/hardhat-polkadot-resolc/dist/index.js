...
(0, config_1.extendConfig)((config, userConfig) => {
    ...
    const hasPolkavm = Object.values(config.networks).some((network) => network && network.polkavm);
    if (!hasPolkavm)
        return;
    ...
    const defaultConfig = isNpm ? constants_1.defaultNpmResolcConfig : constants_1.defaultBinaryResolcConfig;
