...
export declare function getDockerSocketPath(docker?: HardhatNetworkUserConfig["docker"]): Extract<HardhatNetworkUserConfig["docker"], string>;
export declare function waitForServiceToBeReady(port: number, payload: object, maxAttempts: number): Promise<void>;
export declare function getPolkadotRpcUrl(ethRpcUrl: HardhatNetworkConfig["url"], polkadotRpcUrl: HardhatNetworkConfig["polkadotUrl"]): string;
