...
declare const getChainHead$: (chainHead: ChainHead, getCachedMetadata: (codeHash: string) => Observable<Uint8Array | null>, setCachedMetadata: (codeHash: string, metadataRaw: Uint8Array) => void) => readonly [{
    ...
    readonly getRuntime$: (codeHash: string) => Observable<RuntimeContext | null>;
    ...
    readonly storage$: <Type extends StorageItemInput["type"], M extends undefined | ((data: StorageResult<Type>, ctx: RuntimeContext) => any)>(hash: string | null, type: Type, keyMapper: (ctx: RuntimeContext) => string, childTrie?: string | null | undefined, mapper?: M | undefined) => Observable<undefined extends M ? StorageResult<Type> : ReturnType<NonNullable<M>>>;
    ...
    readonly withHodl: (blockHash: string | null) => <T>(base: Observable<T>) => Observable<T>;
    readonly holdBlock: (blockHash: string | null, shouldThrow?: boolean) => typeof noop;
